...
logger=logging.getLogger("modulo_sqrt")
...
def modulo_sqrt_normal_prime(a, p, t, s, b):
    ...
    for k in range(1, t):
        ...
        if imm == 1:
            ...
            logger.debug("imm:%d, imm_v:%d, error"%(imm, imm_v))
            exit(1)
    return x
